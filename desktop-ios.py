...
def run_flutter_and_screenshot(main_dart_file, screenshot_path):
    try:
        ...
        # Resize the window to a mobile view size
        subprocess.call(['osascript', '-e', f'tell application "Google Chrome" to set the bounds of window id {window["kCGWindowNumber"]} to {{100, 100, 375, 667}}'])
